...
- If the lock is flaky at the door: move Dongle-M closer (PoE), then drop an Aqara H2 **Thread** outlet (Power Plug or Wall Outlet H2 EU) between dongle and door — [outlets](outlets.md), [radio](radio.md).
